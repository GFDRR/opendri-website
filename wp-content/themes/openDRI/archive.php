            ...
            <ul class="resource-list-new">
              ...
              <li>
                <div class="thumbnail">
									...
									?>
                  <a href="<?php echo esc_url( get_permalink( $posts_array[ $i ]->ID ) ) ?>">
										<img src="<?php echo $image ?>" alt=""/>
									</a>
                  <div class="text-thumbnail">
                  	<span class="date"><?php echo mysql2date( 'j M Y', $posts_array[ $i ]->post_date ); ?></span>
                    <span class="title">
											<a href="<?php echo esc_url( get_permalink( $posts_array[ $i ]->ID ) ) ?>"><?php echo $posts_array[ $i ]->post_title ?></a>
										</span>
										<?php echo '<p>' . $posts_array[ $i ]->post_excerpt . '</p>'; ?>
                  </div>
                </div>
                <div class="thumbnail">
									<?php
										...
										$image         = $image[0] ? $image : $fallbackImage[0];
									?>
                  <a href="<?php echo esc_url( get_permalink( $posts_array[ $i + 1 ]->ID ) ) ?>">
										<img src="<?php echo $image ?>" alt=""/>
									</a>
                  <div class="text-thumbnail">
                  	<span class="date"><?php echo mysql2date( 'j M Y', $posts_array[ $i + 1 ]->post_date ); ?></span>
                    <span class="title">
											<a href="<?php echo esc_url( get_permalink( $posts_array[ $i + 1 ]->ID ) ) ?>"><?php echo $posts_array[ $i + 1 ]->post_title ?></a>
										</span>
										<?php
